...
description: Core object-oriented design principles and design patterns explained step by step, with diagrams and Python 3.12 examples.
---

# Design Principles and Patterns

Foundations for low-level design. Each page starts from a problem, builds the intuition, then gives the formal definition, code and where it is used in practice.
